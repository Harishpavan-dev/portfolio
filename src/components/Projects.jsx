    ...
    >
      <div className="max-w-[90%] md:max-w-[90%] mx-auto font-inter space-y-10 py-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Project 3 - Student Management System with Attendance Tracking */}
<article className="w-full bg-[#F2EFE5] dark:bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-3 transition-all duration-300" aria-label="Student Management System with Attendance Tracking">
  ...
  <p className="text-lg text-gray-700 dark:text-gray-300 text-center">
    A dynamic web-based system for managing student records, including attendance tracking. Built with PHP, MySQL, JavaScript, and enhanced with features like registration, attendance marking, and report generation.
  </p>
  <div className="flex justify-center gap-4 mt-4">
    <a
      href="https://hnditportal.free.nf/" // Replace with live demo link if available
      target="_blank"
    ...
    <a
      href="#" // Replace with GitHub repo link
      target="_blank"
      rel="noopener noreferrer"
